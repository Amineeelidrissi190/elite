            ...
            {activeStep === steps.length ? (
              ...
              <React.Fragment>
                <Typography sx={{ mt: 2, mb: 1 }} className="heigthp">
                  {activeStep == 0 ? <div className="">
                  ...
                  </div> : activeStep == 1 ? <div className="w-full flex-col h-full flex items-center justify-center">
                    ...
                    <img src={`http://127.0.0.1:8000/storage/photos/specialities/${dataf.emploi_sp}`} alt="" className="h-60" /></div> : <div className='flex md:flex-row flex-col w-full h-full md:items-end items-center md:justify-center justify-start py-3 space-x-0 space-y-2 md:space-x-5'>
